...
define('PG_REQUEST_URL', 'http://uat.lucsonpay.com/crm/jsp/paymentrequest');
define('PG_RESPONSE_URL', 'http://uat.lucsonpay.com/crm/jsp/response.jsp');
...
<head>
    ...
    <title>LucsonPay Demo Merchant Checkout Page</title>
        ...
        <form action="" method="post">
            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="gradientbg">
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="MERCHANTNAME" class="signuptextfield" value="LucsonPay Demo" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_NAME" class="signuptextfield" value="LucsonPay DEMO" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>                   
                <tr>
                ...
                <tr>
                    ...
                    <td width="65%" align="left" valign="middle">
                        <input type="text" name="CUST_EMAIL" class="signuptextfield" value="neeraj.kumar@lucsonpay.com" autocomplete="off"/>
                    </td>
                    <td width="7%" align="left" valign="middle">&nbsp;</td>
                </tr>
                <tr>
